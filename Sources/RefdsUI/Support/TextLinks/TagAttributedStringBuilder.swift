...
final class TagAttributedStringBuilder {
    ...
    func attributedString(
        ...
        textAttributes[.font] = UIFont.refdsUI(size: fontSize, weight: fontWeight.uiKit)
    ...
    func attributedStringForLinks(
        ...
        var textAttributes: [NSAttributedString.Key: Any] = [:]
        textAttributes[.font] = fontSize.map { UIFont.refdsUI(size: $0, weight: fontWeight.uiKit) }
    ...
    func attributedString(
        ...
        switch self {
            case .anchor, .applink:
                ...
                let attributes = [
                    .link: url,
                    .font: UIFont.refdsUI(size: font.pointSize, weight: .medium),
            ...
            case .bold, .strong:
                ...
                if let font = tagTextAttributes[.font] as? UIFont {
                    ...
                    boldFont = .refdsUI(size: font.pointSize, weight: .bold)
                } else {
                    boldFont = .refdsUI(size: .normal, weight: .bold)
                }
            ...
            case .ref:
                ...
                return stringByAddingAttributes(
                    [.foregroundColor: color, .font: UIFont.refdsUI(size: font.pointSize, weight: .bold)],
                    to: currentAttributedString,
                    at: result.ranges[1]
                )
        }
