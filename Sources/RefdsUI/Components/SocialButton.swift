...
public struct SocialButton: View {
    ...
    public var body: some View {
        ...
        .buttonStyle(RefdsUIStyle(backgroundColor: backgroundColor, idealSize: idealSize))
    }
    ...
    var backgroundColor: RefdsUIStyle.BackgroundColor {
        switch service {
            case .apple:        return (
...
extension SocialButton {
    ...
    private static var appleLogoImage: Image {
        if #available(iOS 14.0, *) {
            ...
            return Image.refdsUI(.apple)
        }
    }

    private static let appleLogo = appleLogoImage
    private static let googleLogo = Image.refdsUI(.google).resizable()
    private static let facebookLogo = Image.refdsUI(.facebook).resizable()
